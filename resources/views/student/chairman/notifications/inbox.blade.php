...
@section('title', 'Hộp thư thông báo - Chủ nhiệm CLB')
...
<div class="dashboard-container">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Xem thông báo từ Admin và thông báo nội bộ CLB</p>
    </div>
    ...
    <div class="filter-card">
        <form method="GET">
            <div class="row g-2">
                ...
                <div class="col-md-3">
                    ...
                    <select name="source" class="form-control">
                        ...
                        <option value="club" {{ request('source') == 'club' ? 'selected' : '' }}>Nội bộ CLB</option>
                    </select>
                </div>
                <div class="col-md-2">
            ...
            @if(request()->hasAny(['type', 'source', 'start_date', 'end_date']))
                <div class="row mt-2">
                    <div class="col-md-12">
                        <a href="{{ route('student.chairman.notifications.inbox') }}" class="btn btn-secondary btn-sm">Xóa bộ lọc</a>
                    </div>
                </div>
            @endif
        </form>
                    ...
                    @forelse($notifications as $notification)
                        <tr>
                            ...
                            <td>
                                ...
                                @if(!$notification->is_read_by_chairman)
